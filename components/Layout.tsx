...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed w-full z-50 bg-white border-b border-gray-100 h-[60px] md:h-[80px] flex items-center font-pretendard transition-all shadow-sm">
      <div className="container mx-auto px-5 md:px-6 max-w-[1200px] flex justify-between items-center h-full">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2 group shrink-0">
          ...
          <span className="text-[17px] md:text-xl font-black tracking-tight text-gray-900">
          ...
          <div className="flex flex-col p-6 space-y-4">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`text-lg font-bold py-3 border-b border-gray-50 ${
